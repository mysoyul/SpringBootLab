...
public enum ErrorCode {
    ...
    DEPARTMENT_NOT_FOUND("Department not found with id: %s", HttpStatus.NOT_FOUND),
    ...
    DEPARTMENT_HAS_STUDENTS("Cannot delete department with %s students", HttpStatus.CONFLICT),
