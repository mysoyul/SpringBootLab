...
import com.rookies3.myspringbootlab.service.StudentDetailsService;
...
@RestController
@RequestMapping("/api/students/details")
@RequiredArgsConstructor
public class StudentDetailsController {

    private final StudentDetailsService studentService;
